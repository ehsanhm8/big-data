...
census_data <- census_data|>
  ...
  mutate(HIC_value_with_mortgage_ex =
         ...
         HIC_with_mortgage_m4000 * (nt*3750))/price_index) |>
  mutate(HIC_value_without_mortgage_ex =
         ...
         HIC_without_mortgage_m4000 * (nt*3750))/price_index) |>
  mutate(MOR_value_with_mortgage_ex =
         ...
         MOR_with_m1000000 * (nt*875000))/price_index) |>
  mutate(MOR_value_without_mortgage_ex =
         ...
         MOR_without_m1000000 * (nt*875000))/price_index) |>
  mutate(HIC_value_ex = HIC_value_with_mortgage_ex * houseowners_with_morgage +
         HIC_value_without_mortgage_ex * houseowners_without_morgage) |>
  mutate(MOR_value_ex = MOR_value_with_mortgage_ex * houseowners_with_morgage +
         MOR_value_without_mortgage_ex * houseowners_without_morgage) |>
  mutate(year = 2023)

census_data <- census_data %>%
  select(state, county, year, HIC_value_ex, MOR_value_ex, houseowners, 
         houseowners_with_morgage, houseowners_without_morgage,
